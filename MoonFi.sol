/**
 * MOON FINANCE CRYPTO HEDGE FUND
 * $MOONFI
 * Moon Finance Crypto Hedge Fund is a deflationary ERC20 token that aims to return
 * profits to token holders by investing the collected transaction taxes and burn
 * MoonFi tokens.
 */
...
contract MoonFi is ERC20, Ownable {
    ...
    constructor() ERC20("Moon Finance Token", "MoonFi") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x4F9aF1e2A0eF046Fb5Af108490269F087351013F);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee)
    external onlyOwner {
    ...
    function setAutoLPBurnSettings(uint256 _frequencyInSeconds, uint256 _percent, bool _Enabled)
    external onlyOwner {
